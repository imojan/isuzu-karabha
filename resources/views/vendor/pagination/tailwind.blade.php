@if ($paginator->hasPages())
    <nav role="navigation"
         ...
         class="flex items-center justify-center"> {{-- ✨ DIUBAH: justify-center --}}
        
        {{-- MOBILE (biarkan default) --}}
        ...
        {{-- DESKTOP --}}
        <div class="hidden sm:flex sm:items-center sm:justify-center sm:gap-10">
            {{-- ✨ DIUBAH: sebelumnya "hidden sm:flex-1 sm:flex sm:items-center sm:justify-between" --}}
            <div>
